...
import com.gcit.lms.service.ServiceLocator;

@Controller
public class AdminController {
	
	AdminService admService = (AdminService) ServiceLocator.getInstance().findService("adminService");
	...
	public String addAuthor(Locale locale, Model model) {
		...
		Author author = (Author) ServiceLocator.getInstance().findService("author");
